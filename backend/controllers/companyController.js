    ...
    res.status(200).json({
      ...
      data: {
        company: {
          ...
          brandColor: companyDoc.brandColor || "#2563eb",
          chatColor: companyDoc.chatColor || "#f1f5f9",
          chatBg: companyDoc.chatBg || "#ffffff",
          titleColor: companyDoc.titleColor || "#ffffff",
          textColor: companyDoc.textColor || "#1e293b",
          greeting: companyDoc.greeting || "",
          subtitle: companyDoc.subtitle || "",
...
exports.updateCurrentCompany = async (req, res) => {
  try {
    const fieldsToUpdate = {
      ...
      chatColor: req.body.chatColor,
      chatBg: req.body.chatBg,
